    ...
    <div class="contact-container">
        ...
        <div class="contact-info">
            ...
            <div class="contact-email">
                {{-- Gmail SVG (Color original: #EA4335) --}}
            ...
            <div class="contact-socials">
                {{-- Instagram (Color original: #E1306C) --}}
                ...
                {{-- LinkedIn SVG (Color original: #0077B5) --}}
        ...
        {{-- Columna Derecha: Logo con efecto 3D simulado --}}
        <div class="contact-logo">
            <div class="logo-3d-wrapper">
                <img src="{{ asset('images/logo.png') }}" alt="Tu&Tu Logo" class="logo-layer layer-back">
                <img src="{{ asset('images/logo.png') }}" alt="Tu&Tu Logo" class="logo-layer layer-front">
                <img src="{{ asset('images/logo.png') }}" alt="Tu&Tu Logo" class="logo-layer layer-shadow">
            </div>
        </div>
    </div>
</section>
